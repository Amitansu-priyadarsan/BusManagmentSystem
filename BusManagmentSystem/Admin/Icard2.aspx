<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Icard2.aspx.cs" Inherits="BusManagmentSystem.Admin.Icard2" %>
    ...
    <form id="form1" runat="server">
        <div id="bus-pass">
            ...
            <div id="pass-details" class="underline">
                <label id="pass-title"> S P E C I A L  P A S S</label>
            </div>
